...
def read_ratings(ratings_csv, data_dir="./src/data/raw") -> pd.DataFrame:
    """
...
def read_movies(movies_csv, data_dir="./src/data/raw") -> pd.DataFrame:
    """
...
if __name__ == "__main__":
    ...
    movies.to_csv("./src/data/processed/movie_matrix.csv", index=False)
    user_matrix.to_csv("./src/data/processed/user_matrix.csv")
